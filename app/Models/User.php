 ...
 *     @OA\Property( property="slug", type="string", description="User's website address", nullable=true, example="https://spaceart-lemon.vercel.app/user/2"),
 *     @OA\Property( property="biography", type="string", description="Short presentation text", nullable=true),
 *     @OA\Property( property="received_rates_avg_score", type="number", nullable=true),
 *     @OA\Property( property="artist_account_data", ref="#/components/schemas/Artist", nullable=true),
 *     @OA\Property( property="enterprise_account_data", ref="#/components/schemas/Enterprise", nullable=true),
